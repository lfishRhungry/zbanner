...
typedef enum {
     ...
     */
    PCAP_DLT_NULL       = 0,   /*Null/Loopback [VPN tunnel] ref:
    ...
    PCAP_DLT_LINUX_SLL =
        113, /*ref: https://www.tcpdump.org/linktypes/LINKTYPE_LINUX_SLL.html*/
    PCAP_DLT_PRISM_HEADER =
        119, /*Prism II headers (also used for things like Atheros madwifi) ref:
