...
*/
    ...
    xsum_udp = checksum_udp(px, offset_ip, offset_tcp, tmpl->ipv4.length - offset_tcp);
    xsum_udp = ~xsum_udp;
...
*/
    ...
    px[offset_tcp+6] = (unsigned char)(0);
    px[offset_tcp+7] = (unsigned char)(0);
    xsum_udp = checksum_ipv6(px+offset_ip+8,
                             px+offset_ip+24,
                             IP_PROTO_UDP,
